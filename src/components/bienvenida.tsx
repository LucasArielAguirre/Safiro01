    ...
    className="w-full h-full flex items-center justify-center text-white p-4 ">
      ...
      />
        ...
        className="col-span-4 bg-black bg-opacity-20 backdrop-blur-md rounded-lg p-6 shadow-md flex flex-col justify-center border border-white/10 shadow-black">
          <h3 className="text-lg font-semibold mb-4 font-textbask text-center text-white">REDES</h3>
          <div className="flex gap-4 justify-center items-center">
            <a href="https://kick.com/safiro" target="_blank" className="hover:scale-110 transition-transform">
              <svg
            ...
            <a href="https://www.youtube.com/@SafiroVLR" target="_blank" className="hover:scale-110 transition-transform">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="2em"
                height="2.4em"
            ...
            <a href="https://www.instagram.com/safirovt_/" target="_blank" className="hover:scale-110 transition-transform">
